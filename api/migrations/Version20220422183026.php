 ...
 */
final class Version20220422183026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_role (id INT NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE job_role_department (job_role_id INT NOT NULL, department_id INT NOT NULL, PRIMARY KEY(job_role_id, department_id))');
